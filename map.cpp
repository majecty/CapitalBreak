...
void Map::init(SDL_Surface* back)
{
	...
	building = new Building(180,70,115,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
	building->init(eCardVissa);

	building = new Building(330,70,115,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
	building->init(eCardMister);

	building = new Building(480,70,115,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
	building->init(eCardAmerican);


	building = new Building(180+130,170,170,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
	building->init(eCardNon);


	building = new Building(180,270,115,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
	building->init(eCardUnion);

	building = new Building(330,270,115,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
	building->init(eCardJHT);

	building = new Building(480,270,115,70);
	boxes.push_back(building->get_box());
	buildings.push_back(building);
